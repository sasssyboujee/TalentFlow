  ...
  return (
    <div className="w-full h-full flex flex-col bg-canvas">
      ...
      <header className="px-12 py-8 bg-canvas border-b border-hairline-light shrink-0 text-left max-w-7xl mx-auto w-full flex justify-between items-center">
        <div>
          <h1 className="text-display-md text-ink mb-2 font-semibold tracking-[-1px] uppercase">Interview Schedule</h1>
          <p className="text-sm text-charcoal">Manage scheduled calls, technical rounds, and offer review sessions.</p>
        </div>
        <button
